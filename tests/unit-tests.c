...
void testGetTermuxAppDataDirFromEnv__Basic() {
    ...
    snprintf(rootfs_dir1, sizeof(rootfs_dir1), "%s=/%0*d", ENV__TERMUX_APP__DATA_DIR, TERMUX_APP__DATA_DIR___MAX_LEN - 1, 0);
    ...
    size_t rootfs_dir2_length = snprintf(rootfs_dir2, sizeof(rootfs_dir2), "%s=/%0*d", ENV__TERMUX_APP__DATA_DIR, TERMUX_APP__DATA_DIR___MAX_LEN - 2, 0);
...
void testGetTermuxPrefixDirFromEnv__Basic() {
    ...
    char rootfs_dir1[env_var_size + PATH_MAX];
    snprintf(rootfs_dir1, sizeof(rootfs_dir1), "%s=/%0*d", ENV__TERMUX__PREFIX, TERMUX__PREFIX_DIR___MAX_LEN - 1, 0);
    ...
    char rootfs_dir2[env_var_size + PATH_MAX];
    size_t rootfs_dir2_length = snprintf(rootfs_dir2, sizeof(rootfs_dir2), "%s=/%0*d", ENV__TERMUX__PREFIX, TERMUX__PREFIX_DIR___MAX_LEN - 2, 0);
...
void testGetTermuxRootfsDirFromEnv__Basic() {
    ...
    char rootfs_dir1[env_var_size + PATH_MAX];
    snprintf(rootfs_dir1, sizeof(rootfs_dir1), "%s=/%0*d", ENV__TERMUX__ROOTFS, TERMUX__ROOTFS_DIR___MAX_LEN - 1, 0);
    ...
    char rootfs_dir2[env_var_size + PATH_MAX];
    size_t rootfs_dir2_length = snprintf(rootfs_dir2, sizeof(rootfs_dir2), "%s=/%0*d", ENV__TERMUX__ROOTFS, TERMUX__ROOTFS_DIR___MAX_LEN - 2, 0);
...
void testConvertTermuxAppDataDirToLegacyPath__Basic() {
    ...
    char buf[TERMUX_APP__DATA_DIR___MAX_LEN];
    ...
    snprintf(termux_app_data_dir1, sizeof(termux_app_data_dir1), "/data/user/0/%0*d", TERMUX_APP__DATA_DIR___MAX_LEN - 11, 0);
    ctaddtlp__AEqual(NULL, termux_app_data_dir1, buf, buffer_len);

    char termux_app_data_dir2_1[PATH_MAX];
    snprintf(termux_app_data_dir2_1, sizeof(termux_app_data_dir2_1), "/data/user/0/%0*d", TERMUX_APP__DATA_DIR___MAX_LEN - 11 - 1, 0);
    char termux_app_data_dir2_2[PATH_MAX];
    snprintf(termux_app_data_dir2_2, sizeof(termux_app_data_dir2_2), "/data/data/%0*d", TERMUX_APP__DATA_DIR___MAX_LEN - 11 - 1, 0);
...
void testTermuxPrefixPath__Basic() {
    ...
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR, TERMUX__PREFIX, "/bin", buf, PATH_MAX);
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR "/", TERMUX__PREFIX, "/bin/", buf, PATH_MAX);
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR, TERMUX__PREFIX, "/usr/bin", buf, PATH_MAX);
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR "/", TERMUX__PREFIX, "/usr/bin/", buf, PATH_MAX);
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR "/sh", TERMUX__PREFIX, "/bin/sh", buf, PATH_MAX);
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR "/sh", TERMUX__PREFIX, "/usr/bin/sh", buf, PATH_MAX);
    ...
    tpp__AEqual(TERMUX__PREFIX__BIN_DIR "/sh", TERMUX__PREFIX, TERMUX__PREFIX__BIN_DIR "/sh", buf, PATH_MAX);
...
void testIsPathUnderTermuxAppDataDir__Basic() {
    ...
    bool is_termux_bin_under_termux_app_data_dir = string_starts_with(TERMUX__PREFIX__BIN_DIR, TERMUX_APP__DATA_DIR "/");
    ...
    if (is_termux_app_data_dir_a_legacy_path) {
        ...
        iputadd__ABool(is_termux_bin_under_termux_app_data_dir, TERMUX__PREFIX__BIN_DIR "/sh", NULL, TERMUX_APP__DATA_DIR);
        ...
        iputadd__ABool(is_termux_bin_under_termux_app_data_dir, TERMUX__PREFIX__BIN_DIR "/sh", TERMUX_APP__DATA_DIR, NULL);
    ...
    if (access(TERMUX__PREFIX__BIN_DIR "/sh", X_OK) == 0) {
        ...
        ssize_t length = readlink(TERMUX__PREFIX__BIN_DIR "/sh", real_path, sizeof(real_path) - 1);
...
void testIsPathUnderTermuxRootfsDir__Basic() {
    ...
    bool is_termux_bin_under_termux_rootfs = string_starts_with(TERMUX__PREFIX__BIN_DIR,
...
void testInspectFileHeader__Basic() {
    ...
    string__AEqual(TERMUX__PREFIX__BIN_DIR "/sh", info.interpreter_path);
...
void testModifyExecEnv__setProcSelfExe() {
    ...
    state__ATrue(asprintf(&termux_proc_self_exe, "%s%s", ENV_PREFIX__TERMUX_EXEC__PROC_SELF_EXE, TERMUX__PREFIX__BIN_DIR "/bash") != -1);
    ...
    state__ATrue(allocated_envp != NULL);
    string__AEqual(allocated_envp[0], "MY_ENV=1");
    string__AEqual(allocated_envp[1], ENV__TERMUX_EXEC__PROC_SELF_EXE "=" TERMUX__PREFIX__BIN_DIR "/bash");
    ...
    char *test_env[] = {"MY_ENV=1", ENV__TERMUX_EXEC__PROC_SELF_EXE "=" TERMUX__PREFIX__BIN_DIR "/python", NULL};
    char **allocated_envp;
    modify_exec_env(test_env, &allocated_envp, &termux_proc_self_exe, false);
    state__ATrue(allocated_envp != NULL);
    string__AEqual(allocated_envp[0], "MY_ENV=1");
